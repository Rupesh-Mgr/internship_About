        ...
        <div class="container pt-lg-5 pt-sm-4 pt-2 pb-2">
            <div class="row footer-top-29">
                <div class="col-lg-4 col-md-6 footer-list-29">
                    ...
                    <p class="mb-2 pe-xl-5">Address :Kathmandu,Nepal.
                    </p>
                    <p class="mb-2">Phone Number : <a href="tel:+9779766277015">+977 9766277015</a></p>
                    <p class="mb-2">Email : <a href="mailto:info@example.com">rupeshmagar0077@gmail.com</a></p>
                    <div class="mt-4">
                        <ul class="social">
